...
export default new Map<ProductionType, TypeType>([
  ...
  [ProductionType._ObjectDescriptor, TypeType.ObjectDescriptor ],
  [ProductionType._GeneralString, TypeType.GeneralString ],
  [ProductionType._GraphicString, TypeType.GraphicString ],
  [ProductionType._NumericString, TypeType.NumericString ],
  [ProductionType._PrintableString, TypeType.PrintableString ],
  [ProductionType._TeletexString, TypeType.TeletexString ],
  [ProductionType._UniversalString, TypeType.UniversalString ],
  [ProductionType._UTCTime, TypeType.UTCTime ],
  [ProductionType._ISO646String, TypeType.ISO646String ],
  [ProductionType._IA5String, TypeType.IA5String ],
  [ProductionType._GeneralizedTime, TypeType.GeneralizedTime ],
  [ProductionType._T61String, TypeType.T61String ],
  [ProductionType._UTF8String, TypeType.UTF8String ],
  [ProductionType._UTF8String, TypeType.UTF8String ],
  [ProductionType._VideotexString, TypeType.VideotexString ],
  [ProductionType._VisibleString, TypeType.VisibleString ],
  [ProductionType._BMPString, TypeType.BMPString ],
]);
